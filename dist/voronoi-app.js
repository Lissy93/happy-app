...
var D3Voronoi = /** @class */ (function () {
    ...
    D3Voronoi.prototype.renderTheAwesome = function () {
        ...
        this.sites = d3.range(300).map(function (d) {
    ...
    D3Voronoi.prototype.redrawPolygon = function (polygon) {
        polygon
            ...
            .attr('class', function (d, i) { return 'v-' + i % 9; });
    };
    /**
     * Sets the dimensions and positions of the links between sites
     * @param link
     */
    D3Voronoi.prototype.redrawLink = function (link) {
        link
    ...
    D3Voronoi.prototype.mouseLeaveEvents = function () {
        var that = this;
...
// EXTERNAL MODULE: ./src/styles/voronoi-styles.scss
var voronoi_styles = __webpack_require__(1);

// EXTERNAL MODULE: ./src/scripts/d3-voronoi.ts
var d3_voronoi = __webpack_require__(0);
var d3_voronoi_default = /*#__PURE__*/__webpack_require__.n(d3_voronoi);

// CONCATENATED MODULE: ./src/scripts/page-actions.js
/* Smooth Scrolling for Internal Anchor Links */
/* harmony default export */ var page_actions = (() => {
...
const voronoi = new d3_voronoi_default.a(); // I will go to hell for this next line

Window.finishMdRender = () => page_actions();
